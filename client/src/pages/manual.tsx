...
const modulos: ModuleDoc[] = [
  // ── CORE ONA ────────────────────────────────────────────────────────────────
  {
    ...
    funcionalidades: [
      ...
      { titulo: "Agenda de Comissões", descricao: "Próximas reuniões de comissões (NSP, CCIH, Prontuários...) com data, tipo e status." },
  ...
  },
  {
    ...
    quemUsa: ["NSP", "Gestor de Qualidade", "CCIH", "Diretoria", "Auditoria Interna"],
    funcionalidades: [
  ...
  // ── CLÍNICO ──────────────────────────────────────────────────────────────────
  {
    ...
    quemUsa: ["Diretor Clínico", "CCIH", "NSP", "Comissão de Óbitos", "Gestor de Qualidade"],
    funcionalidades: [
  ...
  },
  {
    ...
    resumo: "Gestão completa das comissões hospitalares obrigatórias (NSP, CCIH, CME, CPRON, COBIO, CEM) com calendário e deliberações.",
    ...
    funcionalidades: [
      { titulo: "6 Comissões Configuradas", descricao: "NSP (Segurança do Paciente), CCIH (Controle de Infecção), CME (Material Esterilizado), CPRON (Prontuários), COBIO (Óbitos e Biópsias) e CEM (Ética Médica) — com regulamentação, sigla e frequência." },
